...
| Model | ID | Best For |
|-------|-----|----------|
| Opus 4.6 | `Codex-opus-4-6` | Complex reasoning, architecture, research |
| Sonnet 4.6 | `Codex-sonnet-4-6` | Balanced coding, most development tasks |
| Haiku 4.5 | `Codex-haiku-4-5-20251001` | Fast responses, high-volume, cost-sensitive |
