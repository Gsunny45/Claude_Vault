---
type: briefing
compiled: "2026-04-15T16:36:18Z"
token_budget: 8000
token_actual: 7989
scope: auto-compiled
notes_included:
  - "llm-orchestrator/frontend/node_modules/ms/license.md"
  - "llm-orchestrator/RUNWAY.md"
  - "memory/context/api-budgets.md"
  - "inbox/2026-04-14.md"
  - "knowledge/KNW-0021.md"
  - "memory/context/api-registry.md"
  - "inbox/2026-04-15.md"
  - "llm-orchestrator/frontend/node_modules/nanoid/README.md"
  - "llm-orchestrator/frontend/node_modules/json5/LICENSE.md"
  - "memory/projects/llm-orchestrator.md"
  - "memory/glossary.md"
  - "llm-orchestrator/frontend/node_modules/@esbuild/linux-x64/README.md"
  - "llm-orchestrator/frontend/node_modules/caniuse-lite/README.md"
  - "llm-orchestrator/frontend/node_modules/react-dom/README.md"
  - "llm-orchestrator/frontend/node_modules/react-router/README.md"
  - "llm-orchestrator/frontend/node_modules/scheduler/README.md"
  - "llm-orchestrator/frontend/node_modules/esbuild/README.md"
notes_excluded_reason:
  - path: "llm-orchestrator/frontend/node_modules/source-map-js/README.md"
    reason: "token budget exceeded (need 6509, remaining 1971)"
  - path: "llm-orchestrator/frontend/node_modules/csstype/README.md"
    reason: "token budget exceeded (need 2722, remaining 1971)"
  - path: "llm-orchestrator/frontend/node_modules/debug/README.md"
    reason: "token budget exceeded (need 5528, remaining 1303)"
  - path: "llm-orchestrator/frontend/node_modules/picomatch/README.md"
    reason: "token budget exceeded (need 7066, remaining 1303)"
  - path: "llm-orchestrator/frontend/node_modules/baseline-browser-mapping/README.md"
    reason: "token budget exceeded (need 5478, remaining 1303)"
---
...
- **Score:** 0.800 (recency=0.81, delta=0.85, links=1.00, importance=0.50)
- **Tokens:** ~270
...
- **Score:** 0.747 (recency=0.99, delta=1.00, links=0.25, importance=0.50)
- **Tokens:** ~2480
...
- **Score:** 0.718 (recency=0.89, delta=1.00, links=0.25, importance=0.50)
- **Tokens:** ~18
...
- **Score:** 0.717 (recency=0.89, delta=1.00, links=0.25, importance=0.50)
- **Tokens:** ~450
...
- **Score:** 0.700 (recency=0.81, delta=0.85, links=0.50, importance=0.50)
- **Tokens:** ~381
...
- **Score:** 0.691 (recency=0.86, delta=0.94, links=0.25, importance=0.50)
- **Tokens:** ~465

**Status:** Active, operational **Location:** `Claude_Vault/llm-orchestrator/` **Started:** 2026-04-13 **Runway doc:** `llm-orchestrator/RUNWAY.md` — start here every session

### [[memory/glossary.md]]

- **Score:** 0.689 (recency=0.86, delta=0.94, links=0.25, importance=0.50)
- **Tokens:** ~316
...
- **Score:** 0.650 (recency=0.81, delta=0.85, links=0.25, importance=0.50)
- **Tokens:** ~36
