...
notes_excluded_reason:
  - path: "decisions/DEC-0001.md"
    reason: "token budget exceeded (need 180, remaining 66)"
  - path: "_templates/weekly.md"
    reason: "token budget exceeded (need 354, remaining 66)"
  - path: "knowledge/KNW-0002.md"
    reason: "token budget exceeded (need 550, remaining 66)"
  - path: "knowledge/KNW-0001.md"
    reason: "token budget exceeded (need 450, remaining 66)"
  - path: "_templates/session.md"
    reason: "token budget exceeded (need 95, remaining 66)"
---
...
- **Score:** 0.627 (recency=0.29, delta=0.91, links=0.33, importance=1.00)
- **Tokens:** ~856
...
- **Score:** 0.597 (recency=0.49, delta=0.95, links=0.33, importance=0.50)
- **Tokens:** ~76
...
- **Score:** 0.596 (recency=0.48, delta=0.95, links=0.33, importance=0.50)
- **Tokens:** ~95
...
- **Score:** 0.571 (recency=0.41, delta=0.93, links=0.33, importance=0.50)
- **Tokens:** ~164
...
- **Score:** 0.563 (recency=0.39, delta=0.93, links=0.33, importance=0.50)
- **Tokens:** ~222
...
- **Score:** 0.561 (recency=0.19, delta=0.90, links=0.67, importance=0.50)
- **Tokens:** ~187
...
- **Score:** 0.558 (recency=0.18, delta=0.90, links=0.67, importance=0.50)
- **Tokens:** ~650
...
- **Score:** 0.555 (recency=0.37, delta=0.93, links=0.33, importance=0.50)
- **Tokens:** ~449
...
- **Score:** 0.541 (recency=0.18, delta=0.90, links=0.33, importance=0.75)
- **Tokens:** ~2368
...
- **Score:** 0.491 (recency=0.18, delta=0.90, links=0.33, importance=0.50)
- **Tokens:** ~500
...
- **Score:** 0.461 (recency=0.29, delta=0.91, links=0.00, importance=0.50)
- **Tokens:** ~109
...
- **Score:** 0.429 (recency=0.20, delta=0.90, links=0.00, importance=0.50)
- **Tokens:** ~977
