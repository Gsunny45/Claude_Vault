...
notes_excluded_reason:
  - path: "inbox/Untitled.md"
    reason: "token budget exceeded (need 12773, remaining 7956)"
  - path: "knowledge/KNW-0004.md"
    reason: "token budget exceeded (need 500, remaining 28)"
  - path: "decisions/DEC-0001.md"
    reason: "token budget exceeded (need 180, remaining 28)"
  - path: "_templates/daily.md"
    reason: "token budget exceeded (need 222, remaining 28)"
  - path: "13 keyboard shortcuts.md"
    reason: "token budget exceeded (need 449, remaining 28)"
---
...
- **Score:** 0.559 (recency=0.53, delta=0.78, links=0.33, importance=0.50)
- **Tokens:** ~31
...
- **Score:** 0.553 (recency=0.36, delta=0.70, links=0.67, importance=0.50)
- **Tokens:** ~44
...
- **Score:** 0.500 (recency=0.40, delta=0.72, links=0.33, importance=0.50)
- **Tokens:** ~1057
...
- **Score:** 0.499 (recency=0.39, delta=0.72, links=0.33, importance=0.50)
- **Tokens:** ~650
...
- **Score:** 0.488 (recency=0.06, delta=0.56, links=1.00, importance=0.50)
- **Tokens:** ~650
...
- **Score:** 0.471 (recency=0.06, delta=0.56, links=0.67, importance=0.75)
- **Tokens:** ~2368
...
- **Score:** 0.471 (recency=0.10, delta=0.58, links=0.33, importance=1.00)
- **Tokens:** ~856
...
- **Score:** 0.423 (recency=0.07, delta=0.56, links=0.67, importance=0.50)
- **Tokens:** ~187
...
- **Score:** 0.402 (recency=0.17, delta=0.61, links=0.33, importance=0.50)
- **Tokens:** ~76
...
- **Score:** 0.401 (recency=0.17, delta=0.61, links=0.33, importance=0.50)
- **Tokens:** ~95
...
- **Score:** 0.390 (recency=0.15, delta=0.60, links=0.33, importance=0.50)
- **Tokens:** ~164
...
- **Score:** 0.390 (recency=0.14, delta=0.60, links=0.33, importance=0.50)
- **Tokens:** ~138
